...
@Component({
  selector: 'app-road-deatils-map',
  //templateUrl: './road-deatils-map.component.html',
  styleUrls: ['./road-deatils-map.component.css'],
...
export class RoadDeatilsMapComponent implements OnInit,OnDestroy {
